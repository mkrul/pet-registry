...
Rails.application.configure do
  ...
  # Emails are saved and viewable at http://localhost:3000/letter_opener
  ...
  # Configure web-console to allow connections from Docker containers and external IPs
  config.web_console.allowed_ips = ['127.0.0.1', '::1', '0.0.0.0/0']
end
