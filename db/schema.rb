...
ActiveRecord::Schema[8.0].define(version: 2025_11_06_084426) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.jsonb "settings", default: {"dark_mode"=>false, "allow_contact"=>true, "email_notifications"=>true}, null: false
