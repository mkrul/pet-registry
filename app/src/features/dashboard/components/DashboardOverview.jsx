    ...
    return (
      <div>
        ...
        <div className="bg-red-50 dark:bg-red-900/30 rounded-lg p-6 text-center">
          <h3 className="text-sm font-medium text-red-900 dark:text-red-400">Error loading activity</h3>
          <p className="mt-1 text-sm text-red-600 dark:text-red-300">Unable to load recent activity. Please try again later.</p>
        </div>
      </div>
    );
  }
    ...
    <div>
      ...
      {events.length === 0 ? (
        <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 text-center">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by creating your first report or registering a pet.</p>
        </div>
      ) : (
        <div>
          <div className="space-y-4">
            {events.map((event) => {
              ...
              return (
              <div key={event.id} className="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:shadow-sm dark:hover:shadow-lg transition-shadow">
                      ...
                      <div className="mt-1">
                        <p className="text-sm text-gray-600 dark:text-gray-300">
                          ...
                          <a
                            ...
                            className="mt-1 inline-flex items-center text-xs text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 hover:underline"
                          >
