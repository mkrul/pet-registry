              ...
              <ul className="flex flex-wrap gap-1 lg:flex-col lg:space-y-2">
                <li className="lg:w-auto">
                  <button
                    ...
                    className={`w-auto lg:w-full text-left px-3 py-2 rounded-md text-sm md:text-sm lg:text-sm font-medium transition-colors whitespace-nowrap lg:whitespace-normal ${
                ...
                <li className="lg:w-auto">
                  <button
                    ...
                    className={`w-auto lg:w-full flex items-center justify-center lg:justify-between text-center lg:text-left px-3 py-2 rounded-md text-sm md:text-sm lg:text-sm font-medium transition-colors whitespace-nowrap lg:whitespace-normal ${
                ...
                <li className="lg:w-auto">
                  <button
                    ...
                    className={`w-auto lg:w-full text-center lg:text-left px-3 py-2 rounded-md text-sm md:text-sm lg:text-sm font-medium transition-colors whitespace-nowrap lg:whitespace-normal ${
